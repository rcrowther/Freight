...
/** Base for representation of Http methods.
 * 
 * i.e. GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT, and PATCH.
 * 
 * Uses a case objects, so can be compared.
 */
///TODO: isSafe is not considered?
...
object HttpMethod {
  ...
  /** Returns a set of common HTTP methods.
   * 
   * i.e. GET, HEAD, POST, PUT, DELETE, TRACE,
   * CONNECT, and PATCH.
   */
